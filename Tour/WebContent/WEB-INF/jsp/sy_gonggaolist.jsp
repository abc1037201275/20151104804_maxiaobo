...
<div class="main clearfix ofHidden block yh">
    ...
    <div class="main_right fright">
    	<div class="title clearfix"><font class="yh f16">动态新闻</font><span class="fright f12">网站首页 > <a href="#">动态新闻</a></span></div>
    	 <c:forEach items="${list}" var="bean">
    	<ul class="text_list">
        <li>> <span>${bean.createtime }</span><a href="/Tour/Nmg/xq_gonggao?id=${bean.id }">${bean.biaoti } </a></li>
      </ul>
      </c:forEach>
