...
<div class="main clearfix ofHidden block yh">
    ...
    <div class="main_right fright">
    	<div class="title clearfix"><font class="yh f16">风景</font><span class="fright f12">网站首页 > <a href="#">风景</a></span></div>
    	<ul class="clearfix pic_list">
    	 <c:forEach  items="${list}" var="bean">
      	<li><a href="method!xq_fengjing?id=${bean.id }" class="pic"><img src="<%=basePath %>/temp/${bean.imgpath}"></a><p><a>${bean.name }</a></p></li>
     </c:forEach>
      </ul>
