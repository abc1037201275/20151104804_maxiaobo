...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+ "/Carparking/uploadfile/";
%>
<!doctype html>
<html lang="zh-cn">
<head>
...
<div class="main clearfix ofHidden block yh">
  <input type="hidden" name="id" value="${bean.id }"/>
    ...
    <div class="main_right fright">
      ...
      <h1 class="bt">${bean.staraddress } &nbsp;  至&nbsp;${bean.endaddress } </h1>
      <div class="date"><span>单价（人/元）:${bean.price}</span></div>
      <div class="nr">
