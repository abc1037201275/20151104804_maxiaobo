...
<div class="main clearfix ofHidden block yh">
    ...
    <div class="main_right fright">
    	<div class="title clearfix"><font class="yh f16">景点</font><span class="fright f12">网站首页 > <a href="#">景点</a></span></div>
    	<br/>

    	<ul class="clearfix pic_list">
    	 <c:forEach  items="${list}" var="bean">
      	<li><a href="/Tour/Nmg/xq_jingdian?id=${bean.id }" class="pic"><img src="<%=basePath %>/photo/${bean.imgpath}"></a><p><a>${bean.name }</a></p></li>
     </c:forEach>
      </ul>
